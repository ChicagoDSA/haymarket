...
- To enable post-error language switching, copy this file into `_pages/ISO-language-code` and remove `permalink`. [Here's a list](https://www.w3schools.com/tags/ref_language_codes.asp) of valid ISO language codes.   
